 ...
 * 기존 AbsExceptionHandleManager를 사용하고 있다면 AbstractExceptionHandleManager 클래스로 변경하는 것을 권장한다. 
 * (AbsExceptionHandleManager는 향후 제거될 예정)
 * </p>
 * @deprecated AbstractExceptionHandleManager로 대체
